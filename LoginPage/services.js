...
app.get('/getUserData', function (req, res) {
  connection.query(
    `Select email_id, password, user_id from users`,
...
app.post('/SignUp', function (req, res) {
  ...
  connection.query(
    `Insert into users (password, email_id) values ('${password}', '${email}')`
  );
...
app.post('/Redirect', function (req, res) {
  ...
  function executeNpmStart() {
    const options = {
      cwd: path.join(__dirname, '../client'), // Specify the folder where npm start should be executed
    };
