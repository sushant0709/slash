...
from scraper.configs import COSTCO, BESTBUY, scrape_ebay, scrape_walmart, scrape_target, scrape_amazon
...
def search(query, config):
    ...
    for res in results:
        ...
        product = form.formatResult(config['site'], title, price, link, image)
